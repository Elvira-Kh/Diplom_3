...
from Diplom_3.fixtures.conftest import main_page, authorize_user, driver, register_user, login_page
from Diplom_3.urls import URL_LOGIN, URL_ACCOUNT_PROFILE, URL_ACCOUNT_ORDERS_HISTORY
...
class TestAccount:
    ...
    def test_not_authorized_click_by_profile_opens_the_account_page(self, main_page, register_user, login_page):
    ...
    def test_authorized_click_by_profile_opens_the_account_page(self, authorize_user, driver, register_user, login_page):
    ...
    def test_click_by_orders_history_opens_the_orders_history_page(self, authorize_user, driver, register_user, login_page):
        main_page = authorize_user['main_page']
        # Делаем клик по "Личный Кабинет"
        main_page.get_account_link().click()
        main_page.wait_for_url(5, URL_ACCOUNT_PROFILE)
    ...
    def test_click_by_exit_opens_the_login_page(self, authorize_user, register_user, login_page):
        main_page = authorize_user['main_page']
        # Делаем клик по "Личный Кабинет"
        main_page.get_account_link().click()
        main_page.wait_for_url(5, URL_ACCOUNT_PROFILE)
