import allure
from Diplom_3.locators import ResetPasswordPageLocators
...
class ResetPasswordPage(BasePage):
    ...
    @allure.step('Найти иконку "Скрыть пароль"')
    def get_hide_password_icon(self):
        return self.find_element(ResetPasswordPageLocators.DIV_HIDE_SHOW_PASSWORD)

    @allure.step('Найти иконку "Показать пароль"')
