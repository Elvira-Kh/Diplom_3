...
class FeedPageLocators:
    ...
    DIV_MODAL_CONTAINER = (By.XPATH,'.//section[contains(@class,"opened")]/div[contains(@class,"Modal_modal__container")]')
    BUTTON_MODAL_CLOSE = (By.XPATH,'.//section[contains(@class,"opened")]/div/button[contains(@class,"Modal_modal__close_modified")]')
